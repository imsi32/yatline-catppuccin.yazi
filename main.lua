...
local function catppuccin_theme(flavor)
  ...
  return {
    ...
    files = { icon = "", fg = catppuccin_palette.blue },
    filtereds = { icon = "", fg = catppuccin_palette.mauve },

    total = { icon = "", fg = catppuccin_palette.yellow },
    success = { icon = "", fg = catppuccin_palette.green },
    failed = { icon = "", fg = catppuccin_palette.red },

    -- yatline-githead
    branch_color = catppuccin_palette.sapphire,
    remote_branch_color = catppuccin_palette.blue,
    tag_color = catppuccin_palette.sky,
    commit_color = catppuccin_palette.mauve,
    behind_remote_color = catppuccin_palette.flamingo,
    ahead_remote_color = catppuccin_palette.lavender,
